...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        top1_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Aatrox",
                ...
                "https://i.ibb.co/TmWMMdy/aatroxrune.png",
                "https://i.ibb.co/HGbzmXX/aatroxability.png",
                "https://i.ibb.co/m4PNpP0/aatroxitem.png"))
        ...
        top2_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Gnar",
                ...
                "https://i.ibb.co/WVh1S7d/gnarrunes.png",
                "https://i.ibb.co/VQFvvgB/gnarabilities.png",
                "https://i.ibb.co/3pdCQfr/gnaritem.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
        ...
        jungle1_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Master Yi",
                ...
                mutableListOf("Double Strike", "https://blitz-cdn.blitz.gg/blitz/lol/passive/MasterYi_Passive1.webp", "https://blitz-cdn-videos.blitz.gg/tooltip_videos/MasterYi/P.webm"),
                ...
                "https://i.ibb.co/xXv90FB/yirunes.png",
                "https://i.ibb.co/T8kRrHy/yiabilities.png",
                "https://i.ibb.co/J3Rymy8/yiitems.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
        ...
        jungle2_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Rengar",
                ...
                mutableListOf("Unseen Predator", "https://blitz-cdn.blitz.gg/blitz/lol/passive/Rengar_P.webp", "https://blitz-cdn-videos.blitz.gg/tooltip_videos/Rengar/P.webm"),
                ...
                "https://i.ibb.co/DfgDQqs/rengarrunes.png",
                "https://i.ibb.co/KWdJB6q/rengarabilities.png",
                "https://i.ibb.co/dmbkpzW/rengaritems.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
        ...
        mid1_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Zed",
                ...
                mutableListOf("Contempt for the Weak", "https://blitz-cdn.blitz.gg/blitz/lol/passive/shadowninja_P.webp", "https://blitz-cdn-videos.blitz.gg/tooltip_videos/Zed/P.webm"),
                ...
                "https://i.ibb.co/f2kTLRM/zedrune.png",
                "https://i.ibb.co/XC2sB0s/zedabilities.png",
                "https://i.ibb.co/j9NNYpM/zeditems.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
        ...
        mid2_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Zoe",
                ...
                mutableListOf("More Sparkles!", "https://blitz-cdn.blitz.gg/blitz/lol/passive/Zoe_P.webp", "https://blitz-cdn-videos.blitz.gg/tooltip_videos/Zoe/P.webm"),
                ...
                "https://i.ibb.co/89v7Nck/zoerunes.png",
                "https://i.ibb.co/7n6DQBz/zoeabilities.png",
                "https://i.ibb.co/3Mk6Q0D/zoeitems.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
        ...
        bot1_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Ezreal",
                ...
                "https://i.ibb.co/XxPWd2R/ezrealrunes.png",
                "https://i.ibb.co/t8qcYzs/ezrealabilities.png",
                "https://i.ibb.co/L1dSsGz/ezrealitems.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
        ...
        bot2_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Xayah",
                ...
                "https://i.ibb.co/4YPZ9Vj/xayahrunes.png",
                "https://i.ibb.co/82CvdC0/xayahabilities.png",
                "https://i.ibb.co/JyyXtRN/xayahitems.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
        ...
        supp1_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Blitzcrank",
                ...
                "https://i.ibb.co/Hh2R4mx/blitzcrankrunes.png",
                "https://i.ibb.co/FX9yt3S/blitzcrankabilities.pngc",
                "https://i.ibb.co/gwc8hvv/blitzcrankitems.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
        ...
        supp2_imageView_main.setOnClickListener {
            ...
            clickedChamp.putExtra(ChampionDetailActivity.EXTRA_CHAMPINFO2, Champion("Soraka",
                ...
                mutableListOf("Salvation", "https://blitz-cdn.blitz.gg/blitz/lol/passive/Soraka_Passive.webp", "https://blitz-cdn-videos.blitz.gg/tooltip_videos/Soraka/P.webm"),
                ...
                "https://i.ibb.co/zGDD7KP/sorakarunes.png",
                "https://i.ibb.co/Q87HWCj/sorakaabilities.png",
                "https://i.ibb.co/sjZBQ9c/sorakaitems.png"))
            top1_imageView_main.context.startActivity(clickedChamp)
        }
    }
}